...
export default function ResumeSection() {
  return (
    <section id="resume" className="mx-auto mt-8 max-w-6xl px-4 py-12">
        ...
        <div>
          ...
          <ol className="mt-6">
            {educationList
              ...
              .map((education) => (
                <EducationListItem
                  key={education.start.getTime() + education.institution}
                  education={education}
                />
              ))}
          </ol>
        ...
        <div>
          ...
          <ol className="mt-6 space-y-4">
            {experienceList
              ...
              .map((experience) => (
                <ExperienceListItem
                  key={experience.endDate + experience.company}
